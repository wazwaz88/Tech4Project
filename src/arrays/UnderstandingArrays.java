...
public class UnderstandingArrays {
    public static void main(String[] args) {
        ...
        // this is only one student's information
        ...
        //int ages = 20, 21, 22; cannot give 3 values in an int
        // String ages = "20, 21, 22"; can do this but problem line 29



        //Can you print Abe's age only? 21

        String[] names = {"Alex", "Abe", "Yakeen"}; // each name has an index starting from 0
        int[] ages = {20, 21, 22};
